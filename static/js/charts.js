...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // 4a. Create a variable that filters the metadata array for the object with the desired sample number.
    var metadata = data.metadata;
    ...
    // 5a. Create a variable that holds the first sample in the metadata array.
    ...
    var wfreqsf = parseFloat(wfreqs).toFixed(1);
    console.log(wfreqsf);
